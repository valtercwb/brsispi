...
public class Nota {
    ...
    public static void alerta(String mensagem) {
        nota(HomeController.getInstance().boxNotas(), mensagem, "ALERTA");
    }

    public static void info(String mensagem) {
        nota(HomeController.getInstance().boxNotas(), mensagem, "INFO");
    }

    public static void erro(String mensagem) {
        nota(HomeController.getInstance().boxNotas(), mensagem, "ERRO");
    }

    public static void confirma(String mensagem) {
        nota(HomeController.getInstance().boxNotas(), mensagem, "CONFIRMAR");
    }
}
