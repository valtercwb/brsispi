...
/**
 * Principal classe para controle e carregamento dos modulos da aplicação, cada menu e alguns submenus da aplicação representa um modulo na aplicação
 */
public class Modulo {
...
//    }
    public static void getEmployee(AnchorPane box) {
        employee = employee == null ? new EmployeeController() : employee;
        config(box, employee);
    }
...
//    }
    /**
     * Configuração da tela de conteúdo para limpar painel e adicionar nova tela, redimensionado seu tamanho para preencher a tela
     */
    ...
    /**
     * Auxiliar na visualização de elementos da tela como: subenus, subtelas e etc...
     */
